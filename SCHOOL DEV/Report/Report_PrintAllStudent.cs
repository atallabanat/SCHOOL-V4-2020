...
{
    public partial class Report_PrintAllStudent : Form
    {
        static string constring = ConfigurationManager.ConnectionStrings["Con"].ConnectionString;
        SqlConnection con = new SqlConnection(constring);
        public Report_PrintAllStudent()
        {
            InitializeComponent();
        }

        private void Report_PrintAllStudent_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportDataSource reportDataSource = new ReportDataSource("DS_PrintAllPaid", m.Tables[0]);
