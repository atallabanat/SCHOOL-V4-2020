...
{
    public partial class PrintPaid4 : UserControl
    {
        ...
        private void PrintPaid4_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid4,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid4 = (string)dr["Paid4"].ToString();
                textBox1.Text = Paid4;
