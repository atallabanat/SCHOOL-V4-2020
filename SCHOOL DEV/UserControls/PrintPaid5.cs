...
{
    public partial class PrintPaid5 : UserControl
    {
        ...
        private void PrintPaid5_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid5,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid5 = (string)dr["Paid5"].ToString();
                textBox1.Text = Paid5;
