...
{
    public partial class PrintPaid2 : UserControl
    {
        ...
        private void PrintPaid2_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid2,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid2 = (string)dr["Paid2"].ToString();
                textBox1.Text = Paid2;
