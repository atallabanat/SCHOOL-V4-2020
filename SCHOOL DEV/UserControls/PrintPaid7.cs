...
{
    public partial class PrintPaid7 : UserControl
    {
        ...
        private void PrintPaid7_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid7,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid7 = (string)dr["Paid7"].ToString();
                textBox1.Text = Paid7;
