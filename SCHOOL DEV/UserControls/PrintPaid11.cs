...
{
    public partial class PrintPaid11 : UserControl
    {
        ...
        private void PrintPaid11_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid11,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid11 = (string)dr["Paid11"].ToString();
                textBox1.Text = Paid11;
