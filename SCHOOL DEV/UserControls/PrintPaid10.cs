...
{
    public partial class PrintPaid10 : UserControl
    {
        ...
        private void PrintPaid10_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid10,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid10 = (string)dr["Paid10"].ToString();
                textBox1.Text = Paid10;
