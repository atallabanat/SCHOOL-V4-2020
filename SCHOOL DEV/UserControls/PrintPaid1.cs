...
{
    public partial class PrintPaid1 : UserControl
    {
        ...
        private void PrintPaid1_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid1,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid1 = (string)dr["Paid1"].ToString();
                textBox1.Text = Paid1;
