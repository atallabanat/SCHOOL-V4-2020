...
{
    public partial class PrintPaid9 : UserControl
    {
        ...
        private void PrintPaid9_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid9,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid9 = (string)dr["Paid9"].ToString();
                textBox1.Text = Paid9;
