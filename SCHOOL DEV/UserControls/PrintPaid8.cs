...
{
    public partial class PrintPaid8 : UserControl
    {
        ...
        private void PrintPaid8_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid8,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid8 = (string)dr["Paid8"].ToString();
                textBox1.Text = Paid8;
