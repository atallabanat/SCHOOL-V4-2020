...
{
    public partial class PrintPaid3 : UserControl
    {
        ...
        private void PrintPaid3_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            na = new SqlCommand("select Paid3,summ,agg,balancee from Paid where name= '" + comboBox1.SelectedValue + "' ", con);
            con.Open();
            na.ExecuteNonQuery();
            SqlDataReader dr;
            ...
            while (dr.Read())
            {
                string Paid3 = (string)dr["Paid3"].ToString();
                textBox1.Text = Paid3;
